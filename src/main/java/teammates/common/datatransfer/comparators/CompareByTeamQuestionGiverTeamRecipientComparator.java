 ...
 */
public class CompareByTeamQuestionGiverTeamRecipientComparator implements Comparator<FeedbackResponseAttributes> {
    private FeedbackSessionResultsBundle feedbackSessionResultsBundle;

    public CompareByTeamQuestionGiverTeamRecipientComparator(FeedbackSessionResultsBundle feedbackSessionResultsBundle) {
    ...
    public int compare(FeedbackResponseAttributes o1, FeedbackResponseAttributes o2) {
        ...
        int order = feedbackSessionResultsBundle.compareByNames(giverTeam1, giverTeam2, isGiverVisible1, isGiverVisible2);
        if (order != 0) {
            return order;
        }
