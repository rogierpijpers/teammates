 ...
 */
public class CompareByGiverRecipientQuestionComparator implements Comparator<FeedbackResponseAttributes> {
    private FeedbackSessionResultsBundle feedbackSessionResultsBundle;

    public CompareByGiverRecipientQuestionComparator(FeedbackSessionResultsBundle feedbackSessionResultsBundle) {
