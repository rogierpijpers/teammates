 ...
 */
public class CompareByTeamRecipientQuestionTeamGiverComparator implements Comparator<FeedbackResponseAttributes> {
    private FeedbackSessionResultsBundle feedbackSessionResultsBundle;

    public CompareByTeamRecipientQuestionTeamGiverComparator(FeedbackSessionResultsBundle feedbackSessionResultsBundle) {
    ...
    public int compare(FeedbackResponseAttributes o1, FeedbackResponseAttributes o2) {
        ...
        order = feedbackSessionResultsBundle.compareByNames(recipientTeam1, recipientTeam2, isRecipientVisible1, isRecipientVisible2);
        if (order != 0) {
            return order;
        }
